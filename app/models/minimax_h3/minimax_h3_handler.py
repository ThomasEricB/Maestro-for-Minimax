...
class family_handler:
    ...
    def query_model_def(base_model_type, model_def):
        ...
        result = {
            ...
            # H3's prompt is a structured multi-field block (see prompt_infos):
            # integrated_multimodal_description / overall_soundscape /
            # non_diegetic_music, separated by blank lines. Maestro otherwise
            # treats each prompt line as its own generation, which would split
